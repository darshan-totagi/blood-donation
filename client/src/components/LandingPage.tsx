      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-5xl">
          <div className="p-6 bg-white shadow-lg rounded-2xl">
            <h3 className="text-2xl font-semibold mb-3 text-red-500">1. Register</h3>
            <p>Sign up as a donor with your details.“Join our community as a donor. It only takes a few minutes, and your small step can save many lives.”</p>
          </div>
          <div className="p-6 bg-white shadow-lg rounded-2xl">
            <h3 className="text-2xl font-semibold mb-3 text-red-500">2. Search</h3>
            <p>Need blood urgently? Quickly search and connect with verified donors near your location in just a few clicks.</p>
          </div>
          <div className="p-6 bg-white shadow-lg rounded-2xl">
            <h3 className="text-2xl font-semibold mb-3 text-red-500">3. Connect</h3>
            <p>Save lives with timely help.Reach out to a donor, donate safely, and make an impact. Your timely help can give someone a second chance at life</p>
          </div>
        </div>
      </section>
...
<footer id="contact" className="bg-red-600 text-white py-8 text-center">
    ...
    <div>
      ...
      <div className="flex justify-center gap-4 mt-2">
        ...
        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
          <svg className="w-6 h-6 fill-current hover:text-gray-200" viewBox="0 0 24 24">
  ...
  <p className="text-sm mt-6">© 2025 BloodConnect. All rights reserved.</p>
</footer>
